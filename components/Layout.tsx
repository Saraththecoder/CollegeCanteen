  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col font-sans">
      <header className="sticky top-0 z-40 bg-black border-b border-white transition-colors duration-300">
            ...
            <div className="flex items-center space-x-6">
              ...
              {user ? (
                <div className="relative group hidden md:block">
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-black border border-white shadow-none rounded-none opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-right">
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden bg-black border-t border-gray-800 px-4 pt-2 pb-4 space-y-1 animate-fade-in">
